    ...
    return (
        <form className='add-form' onSubmit={onSubmit}>
            ...
            <div className='form-control'>
                ...
                <input type='text' placeholder='Add Day & Time' value={day} onChange={handleChangeDay()}/>
            </div>
            <div className='form-control form-control-check'>
                <label>Set Reminder</label>
                <input type='checkbox' placeholder='Set Reminder' value={reminder} onChange={handleChangeReminder()}/>
            </div>
